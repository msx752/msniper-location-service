...
namespace MSniperService.Models
{
    public class PokemonCounter
    {
        ...
        public void Increase(string pokemonName)
        {
            ...
            if (index == -1)
            {
                PCounter.Add(new PokeInfo(pokemonName) { PokemonName = pokemonName.ToLower(), Count = 1 });
            }
            else
            {
        ...
        public void Decrease(string pokemonName)
        {
            ...
            if (index == -1)
            {
                PCounter.Add(new PokeInfo(pokemonName) { PokemonName = pokemonName.ToLower(), Count = 0 });
            }
            else
            {
